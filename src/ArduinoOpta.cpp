...
{
  auto const exp_mech_opcua = opcua::DigitalMechExpansion::create(_server, _node_id, exp_num);
  _dig_mech_exp_list.push_back(exp_mech_opcua);
  return exp_mech_opcua;
}

DigitalStSolidExpansion::SharedPtr ArduinoOpta::create_digital_solid_state_expansion(uint8_t const exp_num)
{
  auto const exp_solid_state_opcua = opcua::DigitalStSolidExpansion::create(_server, _node_id, exp_num);
